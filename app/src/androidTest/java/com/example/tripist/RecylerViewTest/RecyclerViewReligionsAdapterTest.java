...
public class RecyclerViewReligionsAdapterTest {


    public ActivityTestRule<ReligionsCategory> mActivitiyTestRule = new ActivityTestRule<>(ReligionsCategory.class);
