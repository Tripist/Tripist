...
public class MyLocations extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void databaseprepare() {
        try {
            database = MyLocations.this.openOrCreateDatabase("Places", MODE_PRIVATE, null);
