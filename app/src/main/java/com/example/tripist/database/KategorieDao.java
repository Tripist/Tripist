...
public class KategorieDao {
    ...
    public  void add_religions(DatabaseHelper databaseHelper) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
        String toCompile =   "INSERT INTO religions(name,latitude,longitude,image) VALUES ('Suleymaniye Mosque', '41.016177', '28.964153','suleymaniyemin')," +
                "('Blue Mosque', '41.005321', '28.976725','sultanahmet'),('Eyüp Sultan Mosque', '41.048080','28.933879','eyupsultanmosque')," +
                "('Corlulu Ali Pasa Medresesi', '41.008986', '28.968498','corlulualipasamedresesi')," +
                "('Mecidiye(Ortaköy) Mosque', '41.047253' ,'29.027009','ortakoymosque'),('The tomb of Hz. Yuşa', '41.162312', '29.084935','hzyusamin')," +
                "('Aya Yorgi Fener Rum Ortodoks Kilisesi', '41.029232', '28.951637','ayayorgikilisesi')," +
                "('Saint Antoinie Church', '41.032310', '28.977131','stantoiniechurch'),('Virgin Mary Church' , '41.037039', '28.978541','virginmin')," +
                "('Neve Shalom Synagogue' , '41.026877', '28.972623','nevesalommin')";
    ...
    public  void add_parks(DatabaseHelper databaseHelper) {
        ...
        String toCompile = "INSERT INTO parks_gardens(name,latitude,longitude,image) VALUES ('Yıldız Park', '41.049273', '29.015274','yildizpark')," +
                "('Emirgan Park', '41.108846', '29.053083','emirgankorusu')," +
                "('Gulhane Park', '41.013328', '28.981384','gulhanepark'),('Şile Saklıgöl', '41.1194696', '29.591484', 'sakligol')," +
                "('Polonezkoy Nature Park', '41.108598', '29.166018','polonezkoynaturepark'),('Ozgurluk Park', '40.979074', '29.059408','ozgurlukpark')," +
                "('Mihrabat Korusu', '41.096802', '29.068632','mihrabatpark'),('Fethi Paşa Korusu', '41.0967859', '29.0247348','fethipasa')," +
                "('Çamlıca Tepesi', '41.0277528', '29.06622','camlicatepesi'),('Beykoz Korusu', '41.1331274', '29.0963995','beykoz_korusu')," +
                "('Belgrad Forest', '41.1871997', '28.965086','belgrad'),('Atatürk Arboretum', '41.1766262', '28.9831888','ataturkarboretumu')";
        SQLiteStatement sqLiteStatement = database.compileStatement(toCompile);
    ...
    public  void add_bazaarmarkets(DatabaseHelper databaseHelper) {
        ...
        String toCompile = "INSERT INTO bazaar_markets(name,latitude,longitude,image) VALUES ('Spice Bazaar', '41.016536', '28.970594','spicebazaar')," +
                "('Eminönü Bazaar', '41.018297', '28.970953','eminonubazaar'),('Grand Bazaar', '41.010673', '28.968063','grandbazaar')," +
                "('Bakirkoy Bit Pazarı Ve Sanatkarlar Çarşısı', '40.979889', '28.874933','bakirkoy_bitpazari')," +
                "('Üsküdar Fish Market', '41.024469', '29.015983','uskudarfishmarket'),('Bakirkoy Underground Bazaar' , '40.980697', '28.873803','bakirkoy_undergroundbazaar')," +
                "('Great Sinan Bazaar', '41.023742', '29.015950','mimarsinanbazaar'),('Besiktas Fish Market', '41.043512', '29.004666','besiktasfishmarket')";
        SQLiteStatement sqLiteStatement = database.compileStatement(toCompile);
    ...
    public  void add_historicalplaces(DatabaseHelper databaseHelper) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
        String toCompile = "INSERT INTO historical_places (name, latitude, longitude,image) VALUES ('Hagia Sophia Mosque' , '41.008587', '28.980170','ayasofya')," +
                "('Beylerbeyi Palace', '41.042673', '29.039887','beylerbeyimin'),('Galata Tower', '41.025676', '28.974129','galatamin')," +
                "('Hidiv Kasrı', '41.104619', '29.075520','hidivmin'),('Dolmabahce Palace', '41.039168', '29.000454','dolmabahcemin')," +
                "('The Tomb of Haseki Hurrem Sultan' , '41.008611', '28.941855','thetombof_hurremmin')," +
                "('Sultanahmet Square' , '41.005752', '28.975445','sultanahmet_square')," +
                "('The Tomb of Great Sinan', '41.017290', '28.963866','thetombofgreatsinanmin')," +
                "('Maiden’s Tower', '41.021124' ,'29.004111','kizkulesimin'),('Rumeli Fortress', '41.0881692', '29.0406517','rumelihisarimin')," +
                "('Anatolian Fortress', '41.0871851' ,'29.0629042','anadolu_hisarmin'),('Topkapı Palace', '41.0111792', '28.9808382','topkapimin')," +
                "('Çırağan Palace', '41.0434694' ,'29.0134867','ciraganmin'),('Adile Sultan Palace', '41.072334', '29.0556518','adilesultanmin')," +
                "('Haydarpaşa Terminal', '40.9968247' ,'29.0171052','haydarpasamin'),('Castle of the Seven Towers', '40.9938545' ,'28.9210783','yedikule_zindanlarmin')";
        SQLiteStatement sqLiteStatement = database.compileStatement(toCompile);
    ...
    public  void add_islandsandbeachs(DatabaseHelper databaseHelper) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
        String toCompile = "INSERT INTO island_beaches (name, latitude, longitude,image) VALUES ('Büyükada', '40.856003', '29.119722','buyukada')," +
                "('Heybeliada' ,'40.873304', '29.089633','heybeliada'),('Kınalıada', '40.909127', '29.053049','kinaliada')," +
                "('Sedef Island', '40.850309', '29.146068','sedefisland'),('Burgaz Island', '40.879934', '29.068489','burgazada')," +
                "('Kınalıada Public Beach', '40.906846', '29.044361','kinaliada_publicbeach')," +
                "('Ağva Beach', '41.138222', '29.8400537','agvap'),('Ağlayan Kayalar', '41.1748855', '29.6274622','aglayankaya')," +
    ...
    public  void add_museums(DatabaseHelper databaseHelper) {
        ...
        String toCompile =  "INSERT INTO museums(name,latitude,longitude,image)  VALUES ('Tekfur Palace Museum', '41.033806', '28.940487','tekfurpalacemuseum')," +
                ...
                "('Istanbul Modern Art Museum', '41.030076', '28.973875','modern'),('Basilica Cistern', '41.008538', '28.978500','yerebatan_sarnici')," +
                "('Tiled Kiosk', '41.012014', '28.981671','tiledkiosk'),('Istanbul Toy Museum', '40.975939', '29.071127','istanbul_toy_museum')," +
                "('Isbank Museum', '41.016246', '28.973187','isbankmuseum'),('The Panorama 1453 Museum', '41.018350', '28.920981','panaroma_1453_museum')," +
                "('Sakıp Sabancı Museum', '41.105660', '29.056752','sabancimuseum'),('Hagia Irene Church', '41.009626', '28.981216','hagiairene')," +
                "('Miniatürk', '41.0594819', '28.9468834','miniaturk'),('Istanbul Archaeological Museum', '41.0116855', '28.9791418','arkeoloji')," +
    ...
    public  void add_food(DatabaseHelper databaseHelper) {
        SQLiteDatabase database = databaseHelper.getWritableDatabase();
        String toCompile =  "INSERT INTO foods(name,image)  VALUES ('Fish and Bread','fishandbread'),('Acıbadem Cookies','acibademcookie')," +
                "('Black Sea Pita','blackseapita'),('Kanlıca Yogurt','kanlicayogurt'),('Kup Griye','kupgriye'),('Stuffed Mussels','stuffedmussels'),('Ortaköy Baked Potato','ortakoybakedpotato')," +
                "('Wet Burger','wetburger'),('Doner','doner'),('Tantuni','tantuni'),('Waffle','waffle'),('Borek','borek'),('Ottoman Paste','macun'),('Turkish Bagel','simit')," +
                "('Pickle Juice','picklejuice'),('Iskender','iskender'),('Kokoreç','kokorec'),('Chicken and Rice','chickenandrice')," +
                "('Dürüm','durum'),('Halka Tatlısı','halka'),('Baklava','baklava'),('Corn','corn'),('Chesnuts','kestane')," +
                "('Boza','boza'),('Köfte Sucuk Ekmek','koftesucukekmek'),('Turkish Breakfast','turkishbreakfast'),('Çiğ Köfte','cigkofte')," +
                "('Turkish Puddings','pudding'),('Turkish Coffee','turkishcoffee'),('Turkish Ice Cream','dondurma'),('Turnip Juice','salgam'),('Ayran','ayran')," +
